            ...
            {viewMode === 'list' && (
                <div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="adm-empty"><div className="adm-empty-icon">ðŸ“š</div><h3>No resources found</h3><p>Add your first resource.</p></div>
                    ) : (
                        <>
                                            ...
                                            {filtered.map((r,i) => (
                                                <motion.tr key={r.id} initial={{opacity:0}} animate={{opacity:1}} transition={{delay:i*0.04}}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div className="adm-cell-muted">{String(r.description||'').substring(0,60)}{r.description?.length>60?'â€¦':''}</div>
                                                    </td>
