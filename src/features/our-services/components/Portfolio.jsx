import React, { useState } from 'react'; // Refreshing to clear Vite cache
            ...
            <div className="container">
                ...
                >
                    ...
                    <p className="pe-section-subtitle">
                        From intimate wedding invitations to enterprise websites â€” premium quality work
                ...
                <motion.div layout className="pe-portfolio-grid">
                    <AnimatePresence mode="popLayout">
                        {filtered.map((p, i) => (
                            ...
                            >
                                {/* Image area */}
                                <div className="pe-portfolio-img-wrap" onClick={() => navigate(`/services/service/${p.id}`)}>
                                    <img
                                        src={p.img}
                                        alt={p.title}
