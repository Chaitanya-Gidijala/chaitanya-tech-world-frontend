            ...
            {viewMode === 'list' && (
                <div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="adm-empty"><div className="adm-empty-icon">🧠</div><h3>No quizzes found</h3><p>Create your first quiz to get started.</p></div>
                    ) : (
                        <>
                                            ...
                                            {filtered.map((q,i) => (
                                                <motion.tr key={q.id} initial={{opacity:0}} animate={{opacity:1}} transition={{delay:i*0.04}}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div className="adm-cell-muted">{String(q.description||'').substring(0,60)}{q.description?.length>60?'…':''}</div>
                                                    </td>
                                                    <td>
