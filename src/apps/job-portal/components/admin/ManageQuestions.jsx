            ...
            {viewMode === 'list' && (
                <div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="adm-empty"><div className="adm-empty-icon">❓</div><h3>No questions found</h3><p>Try adjusting filters or add new questions.</p></div>
                    ) : (
                        <>
                            {/* Desktop */}
                                            ...
                                            {questions.map((q, i) => (
                                                <motion.tr key={q.id} initial={{opacity:0}} animate={{opacity:1}} transition={{delay:i*0.03}}>
                                                    <td style={{maxWidth:340}}>
                                                        ...
                                                        <div className="adm-cell-muted" style={{fontStyle:'italic'}}>{String(q.answer||'').substring(0,80)}…</div>
                                                    </td>
                        ...
                        <div className="adm-batch-list">
                            ...
                            : batchDrafts.map(d=>(
                                <div key={d.id} className="adm-batch-item">
                                    <div className="adm-batch-item-info"><div><p className="adm-batch-item-title">{d.question}</p><p className="adm-batch-item-meta">{d.difficulty} · {d.tags.join(', ')}</p></div></div>
