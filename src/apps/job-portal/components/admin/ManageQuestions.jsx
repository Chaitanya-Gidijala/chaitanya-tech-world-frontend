                        ...
                        <div style={{ overflowX: 'auto', background: 'var(--jp-glass-bg)', backdropFilter: 'blur(10px)', borderRadius: '16px', border: '1px solid var(--jp-glass-border)', boxShadow: 'var(--jp-shadow)' }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem', color: 'var(--jp-text-main)' }}>
                                <thead style={{ background: 'rgba(0,0,0,0.02)', borderBottom: '2px solid var(--jp-border)' }}>
                                    <tr>
                                        <th style={{ padding: '1.2rem 1rem', textAlign: 'left', fontWeight: 700, color: 'var(--jp-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.75rem' }}>Question</th>
                                        <th style={{ padding: '1.2rem 1rem', textAlign: 'left', fontWeight: 700, color: 'var(--jp-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.75rem' }}>Difficulty</th>
                                        ...
                                        <tr key={q.id} style={{ borderBottom: '1px solid var(--jp-border)' }}>
                                            ...
                                            <td style={{ padding: '1.25rem 1rem', verticalAlign: 'top', textAlign: 'right' }}>
                                                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                                                    <button onClick={() => openEdit(q)} style={{ padding: '0.5rem', borderRadius: '8px', background: 'rgba(99, 102, 241, 0.1)', color: 'var(--jp-primary)', border: 'none', cursor: 'pointer', transition: 'all 0.2sease' }}><Edit2 size={16} /></button>
                                                    <button onClick={() => handleDelete(q.id)} style={{ padding: '0.5rem', borderRadius: '8px', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', border: 'none', cursor: 'pointer', transition: 'all 0.2s ease' }}><Trash2 size={16} /></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
